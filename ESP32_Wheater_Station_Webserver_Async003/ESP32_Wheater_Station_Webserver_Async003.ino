...
void setup(){
  ...
  // ----------Checa si hay conexion con el sensor ----------------------------------------------------------------
  bool status; 
...
// ----------------------------Envio de datos a la pantalla OLED-----------------------------------------------------------
 display.clearDisplay();
 display.setCursor(0,0);
 display.print(readBMP280Temperature().c_str());
 display.print(" ");
 display.cp437(true);
 display.write(248);
 display.print("C");
 display.println(" ");
 display.print(readBMP280Pressure().c_str());
 display.print(" ");
 display.print("Hpa");
 display.display();
  delay(30000);
